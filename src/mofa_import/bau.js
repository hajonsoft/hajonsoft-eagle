...
async function onBAUPageLoad(res) {
  ...
  if (
    ...
    try {
      // Inject eagle preview button in #ctl00_ContentHolder_MYLABEL12

      // The button should read the group code entered by the user from #ctl00_ContentHolder_TxtGroup

      // then redirect to 

      // https://app1.babalumra.com/Groups/EmbassyMutamer.aspx?GroupId=49800&PassId=&Emb=lasten

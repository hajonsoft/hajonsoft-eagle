    ...
    await page.evaluate(
      (params) => {
        ...
        container.outerHTML = `
          ...
          <button style='background-color: #2196f3; color: #ffffff; width: 6rem, padding: 0.5rem; margin: 0 5px; border-radius: 8px;' type="button" onclick="${handleMethodName}();return false">Send إرسل</button> 
          ...
          ${
            ...
            <button onclick="handleLoadImportedOnlyClick();return false" style="color: white; background-color: green; font-size: 1.5rem; font-weight: bold; border-radius: 16px;">Load imported only</button>
...
async function budgieController(page, structure, travellers) {
  if (
    !structure.controller ||
    !structure.controller.selector ||
    !structure.controller.action
    ...
    await page.evaluate(
      (params) => {
        ...
        container.outerHTML = `
          <div style='background-color: #CCCCCC; border: 2px solid black; border-radius: 16px; padding: 0.5rem; display: flex; align-items: center; justify-content: space-between'>  
          <img style='width: 32px; height: 32px; border-radius: 8px; margin-right: 0.5rem'  src='data:image/jpeg;base64,'> </img> 
          <h5 style='margin-right: 0.5rem; color: #311b92'> HAJonSoft-Eagle for Budgie </h5> 

          <button style='background-color: #2196f3; color: #ffffff; width: 6rem, padding: 0.5rem; margin: 0 5px; border-radius: 8px;' type="button" onclick="${handleMethodName}();return false"> تذكر Remember </button> 
          </div>
          `;
      },
      [structure, controllerHandleMethod]
    );
    const isExposed = await page.evaluate(
      (p) => window[p],
      controllerHandleMethod
...
async function handleLoadImportedOnlyClick() {
  ...
  for (const file of files) {
    try {
      if (path.extname(path.join("./", file)) === "") {

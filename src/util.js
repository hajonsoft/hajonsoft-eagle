    ...
    await page.evaluate(
      (params) => {
        ...
        container.outerHTML = `
          ...
          <button style='background-color: #2196f3; color: #ffffff; width: 6rem, padding: 0.5rem; margin: 0 5px; border-radius: 8px; font-size: 2rem;' type="button" onclick="${handleMethodName}();return false"> ${structureParam.controller.title + ' ' + structureParam.controller.arabicTitle} </button> 
          </div>
          `;
      },

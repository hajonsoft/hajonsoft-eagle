      ...
      (params) => {
        ...
        container.outerHTML = `
          ...
          ${
            ...
            <button onclick="handleLoadImportedOnlyClick();return false" style="color: white; background-color: green; font-size: 1.5rem; font-weight: bold; border-radius: 16px;">Offline [node .]</button>
  ...
  try {
    ...
    await page.evaluate(
      (params) => {
        ...
        container.outerHTML = `
          <div style='${controller.leftAlign ? "direction: rtl;" : ""} background-color: #CCCCCC; border: 2px solid black; border-radius: 16px; padding: 0.5rem; display: flex; align-items: center; justify-content: space-between'>  
          <img style='width: 32px; height: 32px; border-radius: 8px; margin-right: 0.5rem'  src='data:image/jpeg;base64,'> </img> 
          <h5 style='margin-right: 0.5rem; color: #311b92'> HAJonSoft-Eagle </h5> 
...
async function handleLoadImportedOnlyClick() {
  ...
  const defaultNationalityCode = await page.$eval("#NationalityIsoCode", (ele) => ele.value);
  const defaultNationalityName = await page.$eval("#NationalityIsoCode", (ele) => ele.options[ele.selectedIndex].text);
  for (const file of files) {
    try {
